...
export default function KYCPage() {
    ...
    const handleSubmit = async (e: any) => {
        ...
        if (res.ok) {
            ...
            router.push(redirect || (userId ? `/dashboard/user?user=${userId}` : '/dashboard'))
        } else {
            const data = await res.json()
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-xl mx-auto space-y-4 p-6 mt-6 border rounded bg-white text-black">
